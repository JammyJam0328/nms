                    ...
                    <nav class="flex-1 px-2 space-y-3  " aria-label="Sidebar">
                        ...
                        <div class="space-y-1" x-data="{account: false}">
                            ...
                            <button :class="account == true ? 'bg-white text-gray-700 border-green-900' : 'text-white'"
                                @click="account = !account" type="button"
                                ...
                                <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24"
                                    fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round"
                                    stroke-linejoin="round" class="feather feather-users mr-3 flex-shrink-0 h-6 w-6 ">
                                ...
                                <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24"
                                    ...
                                    class=" feather feather-chevrons-right ml-3 flex-shrink-0 h-5 w-5 ">
                            ...
                            <div x-show="account" x-cloak x-collapse>
                                <div class="divide-y bg-white shadow rounded-b-md " id="sub-menu-1">
                                    ...
                                    <a href=""
                                        class="text-gray-600  hover:bg-green-50 group flex items-center px-2 py-3 text-sm font-medium">
                                        <!-- Heroicon name: outline/users -->
                        ...
                        <div class="space-y-1">
                            ...
                            <a href="{{ route('admin.meal-plan') }}"
                                ...
                                <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24"
                                    fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round"
                                    stroke-linejoin="round" class="feather feather-package mr-3 flex-shrink-0 h-6 w-6">
                        ...
                        <div class="space-y-1" x-data="{chart: false}">
                            ...
                            <button :class="chart == true ? 'bg-white text-gray-700 border-green-900' : 'text-white'"
                                @click="chart = !chart" type="button"
                                class="hover:bg-white  hover:text-gray-700 border-b-2 group w-full flex items-end uppercase pl-2 pr-1 py-2 text-left  font-bold rounded-md focus:outline-none"
                                aria-controls="sub-menu-1" aria-expanded="false">
                                <!-- Heroicon name: outline/users -->
                                ...
                                <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24"
                                    fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round"
                                    stroke-linejoin="round"
                                    class="feather feather-pie-chart mr-3 flex-shrink-0 h-6 w-6">
                            ...
                            <!-- Expandable link section, show/hide based on state. -->
                            <div x-show="chart" x-cloak x-collapse class="divide-y bg-white shadow rounded-b-md "
                                id="sub-menu-1">
                                <a href="#"
                                    class="text-gray-600  hover:bg-green-50 group flex items-center px-2 py-3 text-sm font-medium">
                                    <!-- Heroicon name: outline/users -->
                        ...
                        <div class="space-y-1">
                            ...
                            <!-- Current: "bg-gray-100 text-gray-900", Default: "bg-white text-gray-600 hover:bg-gray-50 " -->
                            <button
                                class="hover:bg-white text-white  hover:text-gray-700 border-b-2 group w-full flex items-end uppercase pl-2 pr-1 py-2 text-left  font-bold rounded-md focus:outline-none"
                                aria-controls="sub-menu-1" aria-expanded="false">
                                <!-- Heroicon name: outline/users -->
                                ...
                                <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24"
                                    fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round"
                                    stroke-linejoin="round"
                                    class="feather feather-file-text mr-3 flex-shrink-0 h-6 w-6">
                    ...
                    <div class="ml-4 flex items-center md:ml-6">
                        ...
                        <div class="ml-3 relative" x-data="{user:false}" @click.away="user=false">
                            <div class="flex border border-l-2  items-center shadow-md border-gray-600  rounded-l-full">
                                <span class="px-2 ml-3 uppercase font-bold text-gray-800">{{auth()->user()->name}}</span>
