    ...
    <div class="flex space-x-2">
        <div class="w-4/12 ">
            <div class="flex items-center p-1 px-2 bg-white border">
                ...
                <input placeholder="Search ..." wire:model.debounce.500ms="search" type="text"
        ...
        setTimeout(function(){
            ...
            <div class="relative flex items-center px-4 py-4 space-x-3 bg-white border border-green-400 shadow-sm ">
                <div class="flex-shrink-0">
                    <svg xmlns="http://www.w3.org/2000/svg" class="w-10 h-10 text-yellow-400 fill-green-600" fill="none"
                                ...
                                @foreach ($sectionstudents as $student)
                                    <tr>
                                        ...
                                        <td x-data="{bmi:false}"
                                            ...
                                            {{-- bmi --}}
                                            <div x-show="bmi" x-cloak class="fixed inset-0 z-10 overflow-y-auto"
                                                            ...
                                                            <div class="flex mt-4 ">
                                                                <div class="w-4/12 px-2 border-r ">
                                                                    <div>
                                                                        ...
                                                                        @error('height') <span class="text-xs text-red-600 error">{{ $message }}</span> @enderror
                                                                    </div>
                                                                    <div>
                                                                        <label for="company-website"
                                                                        ...
                                                                        @error('weight') <span class="text-xs text-red-600 error">{{ $message }}</span> @enderror
                                                                    </div>
                                                                    <button wire:click="showBMI" class="px-2 mt-2 text-white bg-green-700 rounded-md hover:bg-green-900">Add BMI</button>
                                                                </div>
                                                                <div class="relative w-8/12 px-2  h-96">
                                                                    <div class="absolute bottom-0">
                                                                        <button @click="bmi=false" class="px-2 text-white bg-red-600 rounded-md">Close</button>
                                                                    </div>
                                                                <div class="flex items-center justify-between border-b header">
